(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["ReactSummernote"] = factory(root["$"], root["React"]);
})(
  this,
  function (__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_8__) {
      ...
      /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
          /* WEBPACK VAR INJECTION */ (function (jQuery) {
             ...
             */
            (function webpackUniversalModuleDefinition(root, factory) {
              if (true) module.exports = factory(__webpack_require__(1));
              else if (typeof define === "function" && define.amd)
              ...
              return /******/ (function (modules) {
                ...
                /******/ {
                  ...
                  /***/ 3: /***/ function (
                    ...
                    var isSupportAmd =
                      "function" === "function" && __webpack_require__(2); // eslint-disable-line
                    ...
                    function isList(node) {
                      return (
                        node && /^UL|^OL/.test(node.nodeName.toUpperCase())
                      );
                    }
                    ...
                    function dom_isCell(node) {
                      return (
                        node && /^TD|^TH/.test(node.nodeName.toUpperCase())
                      );
                    }
                          ...
                          value: function createInvokeHandler(
                            ...
                            return function (event) {
                              ...
                              _this4.invoke(
                                namespace,
                                value ||
                                  $target.closest("[data-value]").data("value"),
                                $target
                              );
                            };
                          },
                    ...
                    function textRangeToPoint(textRange, isStart) {
                      ...
                      for (offset = 0; offset < childNodes.length; offset++) {
                        ...
                        if (
                          tester.compareEndPoints("StartToStart", textRange) >=
                          0
                        ) {
                          break;
                        }
                    ...
                    /* harmony default export */ var range = {
                       ...
                       * @return {WrappedRange}
                       */
                      createFromNodeBefore: function createFromNodeBefore(
                        node
                      ) {
                              ...
                              if (this.options.codeviewIframeFilter) {
                                ...
                                value = value.replace(
                                  ...
                                  function (tag) {
                                    ...
                                    var _iterator =
                                        _createForOfIteratorHelper(whitelist),
                                      _step;
                              ...
                              return _this2.ui
                                .buttonGroup([
                                  _this2.button({
                                    ...
                                    contents: _this2.ui.dropdownButtonContents(
                                      _this2.ui.icon(
                                        _this2.options.icons.alignLeft
                                      ),
                                      _this2.options
                                    ),
                              ...
                              return _this2.ui
                                .buttonGroup([
                                  _this2.button({
                                    ...
                                    contents: _this2.ui.dropdownButtonContents(
                                      _this2.ui.icon(
                                        _this2.options.icons.textHeight
                                      ),
                                      _this2.options
                                    ),
                                  ...
                                  ],
                                  {
                                    callback: function callback($node) {
                                      ...
                                      $catcher
                                        .css({
                                          width:
                                            _this2.options.insertTableMaxSize
                                              .col + "em",
                                          height:
                                            _this2.options.insertTableMaxSize
                                              .row + "em",
                              ...
                              function () {
                                return _this4
                                  .button({
                                    ...
                                    click:
                                      _this4.context.createInvokeHandler(
                                        "linkDialog.show"
                                      ),
                                  })
                                  .render();
                            ...
                            this.showImageDialog()
                              .then(function (data) {
                                ...
                                if (typeof data === "string") {
                                  ...
                                  if (
                                    _this.options.callbacks.onImageLinkInsert
                                  ) {
                                    _this.context.triggerEvent(
                                      "image.link.insert",
                                      data
                    ...
                    function ImagePopover_classCallCheck(
                      instance,
                      Constructor
                    ) {
                      if (!(instance instanceof Constructor)) {
                    ...
                    function TablePopover_classCallCheck(
                      instance,
                      Constructor
                    ) {
                      if (!(instance instanceof Constructor)) {
                  ...
                  /***/ 52: /***/ function (
                    ...
                    var dropdownButtonContents =
                      function dropdownButtonContents(contents, options) {
                        return (
                          contents + " " + icon(options.icons.caret, "span")
                        );
                      };
            ...
            var ReactSummernote = (function (_Component) {
              ...
              function ReactSummernote(props) {
                ...
                var _this = _possibleConstructorReturn(
                  this,
                  (
                    ReactSummernote.__proto__ ||
                    Object.getPrototypeOf(ReactSummernote)
                  ).call(this, props)
                );
